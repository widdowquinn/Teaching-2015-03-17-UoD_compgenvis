...
\input{sections/whole_genome_comparison_intro}
% SUBSECTION
% DNA-DNA hybridisation
\subsection{DNA-DNA hybridisation and ANI}
\input{sections/ddh_expt}
\input{sections/ani}
% SUBSECTION
% Computational comparisons
\subsection{Whole genome comparisons}
\input{sections/genome_comparisons_expt}
\input{sections/pairwise_genome_alignment}
\input{sections/multiple_genome_alignment}
